...
const dietSchema = z.object({
    ...
    nivel_atividade:z.enum(["sedentario", "2x_semana", "4x_semana"], { error: "Selecione o nível de atividade física" }),
...
export function DietForm({ onSubmit }: DietFormProps){
    ...
    return(
        <div className="min-h-screen flex items-center justify-center p-4">
            <Card className="max-w-2xl border-0">
                <div className="p-8">
                    ...
                    <Form {...form}>
                        ...
                        >
                            ...
                            <Button className="w-full mt-6 hover:opacity-90 cursor-pointer" type="submit">Gerar minha dieta</Button>
                        </form>
                    </Form>
                </div>
            </Card>
